          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="show-result.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Show Result</p>
                  </a>
                </li>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Result-Exam</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
                        <div class="card" >
                            <div class="card-header" id="card">
                                <strong class="card-title">Result of Exam</strong>
                            </div>
                            <div class="card-body">
                            	  <?php      
             $stmt = $con->prepare("SELECT * FROM answer_quiz ORDER BY percentage_correct DESC");
             $stmt->execute();
 ...
 <table id="example" class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th class="text-center">Not answer</th>
        ...
        <?php foreach ($rows as $row) : ?>      
            <tr>
                <td class="text-center"><?= $row['name_user'] ?></td>
                <td class="text-center"><?= $row['name_cours'] ?></td>
                 <td class="text-center"><?= $row['rightAnswer'] ?></td>
                <td class="text-center"><?= $row['noAnswer'] ?></td>
               <td class="text-center"><?= $row['wrongAnswer'] ?></td>
                <td class="text-center"><?php if($row['percentage_correct'] >= 80){ ?>
              <p class="text-success text-center"><?= $row['percentage_correct'] ?>%</p>
               <?php  }
               elseif ($row['percentage_correct'] <= 20) { ?>
                <p class="text-danger text-center"><?= $row['percentage_correct'] ?>%</p>
              <?php } else{ ?>
               <p class="text-info text-center"><?= $row['percentage_correct'] ?>%</p>
              <?php }


                  ?></td>
                 <td class="text-center"><?= $row['time_start'] ?></td>
                 <td class="text-center"><?= $row['finisht_time'] ?></td>
