 ...
 if (isset($_POST['submit']))
{
  ...
  $answer = $_POST['answer'];
  $cours = $_POST['cours'];
  $sql = "INSERT INTO question_quiz (question,ans1,ans2,ans3,ans4,ans,cours) VALUES('$question', '$ops1', '$ops2','$ops3', '$ops4','$answer','$cours')";
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="creat-exam.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Creat Exam</p>
                  </a>
                </li>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Opsion 1</label>
      <input type="text" class="form-control" name="ops1" placeholder="Opsion 1">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Opsion 2</label>
      <input type="text" class="form-control" name="ops2" placeholder="Opsion 2">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Opsion 3</label>
      <input type="text" class="form-control" name="ops3" placeholder="Opsion 3">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Opsion 4</label>
      <input type="text" class="form-control" name="ops4" placeholder="Opsion 4">
    </div>
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      <label for="inputState">Cours</label>
...
<?php } ?>
  ...
  <button type="submit" name="submit" class="btn btn-primary btn-lg btn-block">Create Exam</button>
</form>
                </div>
                <!-- /.card-body -->
              </div>
