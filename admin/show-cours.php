        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="show-cours.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Show Course</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Show-Course</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <table id="example" class="table  responsive nowrap  table-responsive-sm" style="width:100%">  
                	   <?php      
             $stmt = $con->prepare("SELECT * FROM cours ORDER BY id DESC");
             $stmt->execute();
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $value['price'] ?></td>
  <td><button type="button" class="btn btn-primary btn-sm edit_data" id="<?php echo $value["id"]; ?>" >Update</button>&nbsp;<button type="button" class="btn btn-danger btn-sm delete_data"  id="<?php echo $value["id"]; ?>">Delete</button></td>
                <td><?= $value['content'] ?></td>
          ...
          <!--     Ketu eshte modal per update//////     -->
 <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="" method="post" id="updateForm"> 
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update the Cours</h5>
