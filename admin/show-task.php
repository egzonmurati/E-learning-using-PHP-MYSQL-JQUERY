                  ...
                  ?>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="show-task.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Show Task</p>
                                    </a>
                                </li>
            ...
            <section class="col-md-10" style="margin: 0 auto;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <table id="table_id" class="display table  responsive" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Title of Task</th>
                                    <th>Name of Cours</th>
                            ...
                            <tbody>
                                <?php foreach ($task as $value) : ?>
                                    <tr>
                                        ...
                                        <td><?= $value['name_cours'] ?></td>
                                        <td><?= $value['pdf_file'] ?></td>
                                        <td><button type="button" class="btn btn-primary btn-sm show_data" data-toggle="tooltip" data-placement="top" title="Show a task!" id="<?php echo $value["id_task"]; ?>"><i class="fa fa-eye fa-lg"></i> </button>&nbsp;
                                            <button type="button" class="btn btn-info btn-sm dowloand_data" data-toggle="tooltip" data-placement="top" title="Dowloand a task!" id="<?php echo $value["id_task"]; ?>"><i class="fa fa-download fa-lg"></i> </button>&nbsp;
                                            <button type="button" class="btn btn-danger btn-sm delete_data" data-toggle="tooltip" data-placement="top" title="Delete a task!" id="<?php echo $value["id_task"]; ?>"><i class="fa fa-trash fa-lg"></i> </button>
                                        </td>
                        ...
                        <!--     Ketu eshte modal per show task//////     -->
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form action="" method="post" id="updateForm">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Show the Task of Cours</h5>
