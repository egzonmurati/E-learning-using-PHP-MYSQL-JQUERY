 ...
 if (isset($_POST['submit']))
{
  ...
  $sql = "INSERT INTO noftication (content,createDate) VALUES('$notifications', '$datenow')";
            ...
            if (mysqli_query($con, $sql)) {
                   ...
                   $message =  '<center><div  class="alert alert-success" role="alert">Notifications uploaded successfully!</div></center>';
            }
        else {
           $message =  '<center><div  class="alert alert-danger" role="alert">Failed to upload Notifications!</div></center>';
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
             ...
             <button  type="submit" name="submit" class="btn btn-primary">Save Notifications</button>
      </div>
       </form>
                </div>
                <!-- /.card-body -->
